...
import type { OpenapiClient, OpenapiRequestCommonOptions } from 'openapi-angular';
  ...
  implements OpenapiResourceRef<T>
{
  ...
  constructor(
    ...
    openapiOptions?: OpenapiRequestCommonOptions<unknown>,
  ) {
    super(
      request,
    ...
    this.client = openapiClient({ ...openapiOptions, injector });
  }
